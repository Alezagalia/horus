 ...
 */
export const generalLimiter = rateLimit(getGeneralRateLimitOptions()) as unknown as RequestHandler;

/**
 * Strict rate limiter for authentication endpoints
 * Prevents brute force attacks on login/register
 */
export const authLimiter = rateLimit(getAuthRateLimitOptions()) as unknown as RequestHandler;
