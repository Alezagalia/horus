...
export const pushEnvelopeSchema = z.object({
  changes: z.object({
    ...
    foods: tableChangesSchema,
    recipes: tableChangesSchema,
    recipe_ingredients: tableChangesSchema,
    meal_plans: tableChangesSchema,
    meal_entries: tableChangesSchema,
    meal_entry_items: tableChangesSchema,
    nutrition_logs: tableChangesSchema,
    nutrition_log_items: tableChangesSchema,
    shopping_lists: tableChangesSchema,
    shopping_list_items: tableChangesSchema,
    exercises: tableChangesSchema,
    routines: tableChangesSchema,
    routine_exercises: tableChangesSchema,
    workouts: tableChangesSchema,
    workout_exercises: tableChangesSchema,
    workout_sets: tableChangesSchema,
  }),
