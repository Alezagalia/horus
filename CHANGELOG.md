...
- **[2026-06-27]** S-05 (Comercialización, Fase 2): IAP de Google Play en mobile + verificación server-side
  Compras in-app nativas para el plan Pro (las tiendas prohíben el pago web externo para bienes digitales, así que mobile NO usa Lemon Squeezy). Cliente: `react-native-iap@^12` (compatible con old-arch/Paper, RN 0.76) + config plugin que agrega el permiso `BILLING`. Hook `useProPurchase` corre el flujo de compra (initConnection → getSubscriptions → requestSubscription con offerToken → finishTransaction) y manda el `purchaseToken` al backend; el require de la librería nativa es lazy para no romper Expo Go. Backend: `googlePlay.service.ts` verifica el token contra la **Play Developer API** (googleapis, ya instalado), acknowledgea la compra (best-effort) y hace upsert de `Subscription` (provider `GOOGLE_PLAY`, reusa el patrón de `lemonSqueezy.service`); rechaza productos que no vendemos. `POST /api/billing/google/verify` (auth + gate de email verificado) devuelve los entitlements; `POST /api/billing/google/rtdn?secret=…` recibe las Real-Time Developer Notifications vía Pub/Sub (renovaciones/cancelaciones/refunds) y re-sincroniza. El enum `SubProvider` ya incluía `GOOGLE_PLAY` → **sin migración**. Claves vía `.env` (opcionales → verify 503 hasta configurar). Guía de setup manual (Play Console, service account, Pub/Sub) en `docs/google-play-iap-setup.md`.
  - Backend: apps/backend/src/services/googlePlay.service.ts, apps/backend/src/controllers/billing.controller.ts, apps/backend/src/routes/billing.routes.ts, apps/backend/src/config/env.ts, apps/backend/.env.example
  - Mobile: apps/mobile/src/hooks/useProPurchase.ts, apps/mobile/src/config/billing.ts, apps/mobile/src/services/api/subscriptionApi.ts, apps/mobile/app/(tabs)/yo.tsx, apps/mobile/app.json, apps/mobile/package.json
  - Tests: apps/backend/src/services/googlePlay.test.ts (18) + routes/billing.test.ts (+5) ; apps/mobile/src/hooks/**tests**/useProPurchase.test.ts (2)
  - Docs: docs/google-play-iap-setup.md
  - Relacionado: docs/comercializacion-plan-implementacion.md (S-05)
...
- **[2025-11-30]** US-133: Pantalla de Gestión de Rutinas (Mobile) - Versión Base
  ...
  - Relacionado: US-126, US-127, US-132, US-140

### Added

- **[2025-11-30]** US-132: Pantalla de Gestión de Ejercicios (Mobile)
  ...
  - Relacionado: US-126, US-127, US-140

### Added

- **[2025-11-30]** US-131: Endpoints de Estadísticas de Progreso
  ...
  - Relacionado: US-130, US-126, US-128, US-129

### Added

- **[2025-11-30]** US-130: Endpoints para Finalizar Entrenamiento y Calcular Estadísticas
  ...
  - Relacionado: US-130, US-128, US-129, US-125

### Added

- **[2025-11-30]** US-129: Endpoints para Registrar Series de Entrenamiento
  ...
  - Relacionado: US-129, US-128, US-125

### Added

- **[2025-11-30]** US-122: Recurring Expenses Page Web
  ...
  - Relacionado: US-084, US-088

### Added

- **[2025-11-30]** US-121: Transfer Modal Component and Integration
  ...
  - Relacionado: US-120, US-119

### Added

- **[2025-11-30]** Integración de Google Calendar en Web
  ...
  - Relacionado: US-118, US-117

### Added

- **[2025-11-30]** Implementación de Página de Calendario Mensual (Web)
...
- **[2025-11-29]** US-115: Monitoring y Logging en Producción con Sentry y Winston
...
- **[2025-11-29]** CI/CD Completo con GitHub Actions (TECH-001)
  ...
  - Relacionado: TECH-001, US-114

### Added

- **[2025-11-29]** Tests E2E en Web con Playwright (US-112)
...
- **[2025-11-29]** Tests E2E en Mobile con Detox (US-111)
...
- **[2025-11-29]** US-110: Backend Performance Optimization
...
- **[2025-11-29]** US-109: Web Performance Optimization
...
- **[2025-11-29]** US-108: Mobile Performance Optimization
...
- **[2025-11-29]** US-107: Web Push Notifications con Service Worker
  ...
  - Relacionado: US-105, US-106, US-S12-008

### Added

- **[2025-11-27]** US-106: Push Notifications en Mobile con Expo Notifications
  ...
  - Relacionado: US-105, US-S12-002, US-S12-007

### Added

- **[2025-11-26]** US-105: Firebase Cloud Messaging Setup - Backend Infrastructure
  ...
  - Relacionado: US-036, US-106, US-107

### Added

- **[2025-11-26]** Optimizaciones de Performance y PWA para Lighthouse
  ...
  - Relacionado: US-104, TECH-002

### Added

- **[2025-11-26]** Sistema de Atajos de Teclado Global para Web
  ...
  - Componentes: apps/web
  - Relacionado: US-103, TECH-001

### Changed

- **[2025-11-26]** Migración de @horus/shared de CommonJS a ESM
  ...
  - ⚠️ **BREAKING CHANGE**: Requiere migración
  - Relacionado: US-102

### Added

- **[2025-11-26]** Integración de US-101 con backend API - Sistema de tareas completo
  ...
  - Relacionado: US-101, US-057, US-058, US-060

### Added

- **[2025-11-25]** Implementación completa del sistema de gestión de tareas (US-101)
...
- **[2025-11-25]** Página de Estadísticas Detalladas de Hábitos con Visualizaciones
  ...
  - Relacionado: US-099, US-098, US-096

### Added

- **[2025-11-25]** Página de Gestión Completa de Hábitos con CRUD
  ...
  - Relacionado: US-098, US-096, US-091, US-092

### Added

- **[2025-11-23]** Endpoints para Editar y Deshacer Pagos de Gastos Mensuales - US-087
  ...
  - Relacionado: US-086 (Marcar como pagado), US-083 (Modelos de Gastos Recurrentes), US-085 (Obtener instancias mensuales), Sprint 9 Transaction model, Sprint 9 Account model

### Added

- **[2025-11-23]** Endpoint para Marcar Gasto Mensual como Pagado con Transacción Atómica - US-086
  ...
  - Componentes: Backend API, MonthlyExpense Service Layer, MonthlyExpense Controllers, Transaction Model, Account Model, Atomic Transactions, Zod Validations
  - Relacionado: US-083 (Modelos de Gastos Recurrentes), US-085 (Obtener instancias mensuales), US-087 (siguiente: Editar/deshacer pago), Sprint 9 Transaction model, Sprint 9 Account model

### Added

- **[2025-11-23]** Endpoints para Obtener Instancias Mensuales de Gastos - US-085
  ...
  - Relacionado: US-083 (Modelos de Gastos Recurrentes), US-084 (Endpoints CRUD plantillas), US-086 (siguiente: Marcar gasto como pagado)

### Added

- **[2025-11-23]** Endpoints CRUD de Plantillas de Gastos Recurrentes - US-084
  ...
  - Relacionado: US-083 (Modelos de Gastos Recurrentes), US-085 (siguiente: Generación de instancias mensuales)

### Changed

- **[2025-11-23]** Modelos de gastos recurrentes y instancias mensuales
  ...
  - Relacionado: Sprint 9 - Modelos Account, Transaction, Category (dependencias), US-084 - Endpoints CRUD de gastos recurrentes (siguiente), US-085 - Generación automática de instancias mensuales (siguiente)

### Added

- **[2025-11-23]** Pantalla TransferScreen para transferencias entre cuentas
  ...
  - Relacionado: US-076 (Endpoint de transferencias - backend requerido), US-081 (CreateTransactionScreen - componentes reutilizados), US-S9-006 (AccountsScreen - posible destino de navegación)

### Added

- **[2025-11-23]** Pantalla CreateTransactionScreen para ingresos y egresos
  ...
  - Relacionado: US-075 (Endpoints de transacciones - backend requerido), US-S9-008 (AccountDetailScreen - destino de navegación), US-S9-006 (AccountsScreen - posible punto de entrada)

### Added

- **[2025-11-23]** Pantalla AccountDetailScreen con transacciones
  ...
  - Relacionado: US-S9-006 (AccountsScreen - screen origen de navegación), US-S9-009 (CreateTransactionScreen - destino de FAB), US-S9-007 (CreateAccountScreen - misma estructura de componentes)

### Added

- **[2025-11-23]** Implementación de Pantalla CreateAccountScreen con Formulario Completo y Pickers Personalizados
  ...
  - Relacionado: US-079, US-078, US-074

### Added

- **[2025-11-23]** Implementación de Pantalla AccountsScreen con Dashboard Financiero Completo
  ...
  - Relacionado: US-078, US-077, US-074

### Added

- **[2025-11-22]** Implementación de Endpoint de Estadísticas Financieras con Agregaciones y Evolución Mensual
  ...
  - Relacionado: US-077, US-075, US-074, US-073

### Added

- **[2025-11-22]** Implementación de Endpoint de Transferencias entre Cuentas con Transacciones Vinculadas
  ...
  - Relacionado: US-076, US-075, US-074, US-073

### Added

- **[2025-11-22]** Implementación de Endpoints CRUD de Transacciones con Actualizaciones Atómicas de Balance
  ...
  - Relacionado: US-075, US-073, US-074

### Added

- **[2025-11-22]** Endpoints CRUD de transacciones con actualización atómica de balances
  ...
  - Relacionado: US-073, US-074, US-076

### Added

- **[2025-11-22]** Endpoints CRUD completos para gestión de cuentas financieras
  ...
  - Relacionado: US-073, US-075, US-076

### Added

- **[2025-11-22]** Modelos Account y Transaction para gestión financiera
  ...
  - Relacionado: US-074, US-075, US-076

### Added

- **[2025-11-22]** Pantalla de Configuración de Sincronización con Google Calendar
  ...
  - Relacionado: US-067, US-068, US-069, US-070

### Added

- **[2025-11-22]** Pantallas CreateEventScreen y EditEventScreen - US-071
  ...
  - Relacionado: US-071, US-066, US-070

### Added

- **[2025-11-22]** Pantalla CalendarScreen con Vista Mensual - US-070
  ...
  - Relacionado: US-070, US-066, US-069

### Added

- **[2025-11-22]** Sincronización Google → Local (Importar) - US-069
  ...
  - Relacionado: US-069, US-068, US-067, US-066, US-065

### Added

- **[2025-11-22]** Sincronización Local → Google Calendar (Exportar) - US-068
  ...
  - Relacionado: US-068, US-067, US-066, US-065

### Added

- **[2025-11-22]** Implementación de OAuth2 Flow con Google Calendar (US-067)
...
- **[2025-11-22]** US-061: Pantalla TareasScreen con Listado y Filtros
...
- **[2025-11-22]** US-060: Endpoint de Toggle de Estado de Tarea
...
- **[2025-11-22]** US-059: Cron Job de Archivado Automático
...
- **[2025-11-22]** US-058: Endpoints de Gestión de Checklist
...
- **[2025-11-22]** US-057: Endpoints CRUD de Tareas
...
- **[2025-11-22]** US-056: Modelos Task y TaskChecklistItem en Base de Datos
...
- **[2025-11-21]** US-055: Sistema de Notificaciones Locales con Expo
  ...
  - Relacionado: US-055, US-054

### Added

- **[2025-11-21]** US-054: Configuración de Notificaciones en EditHabitScreen
  ...
  - Relacionado: US-054, US-051

### Added

- **[2025-11-21]** US-053: Feature de Reactivación en HabitosScreen
  ...
  - Relacionado: US-053, US-049, US-024

### Added

- **[2025-11-21]** US-052: Pantalla HabitAuditScreen - Timeline de Cambios
  ...
  - Relacionado: US-052, US-048

### Added

- **[2025-11-21]** US-051: Endpoint de Configuración de Notificaciones
  ...
  - Relacionado: US-051, US-050

### Changed

- **[2025-11-21]** US-050: Modelo NotificationSetting para Recordatorios
...
- **[2025-11-21]** US-049: Endpoint de Reactivación de Hábitos
  ...
  - Relacionado: US-046, US-047, US-049

### Added

- **[2025-11-21]** US-048: Endpoint de Historial de Cambios
  ...
  - Relacionado: US-046, US-047, US-048

### Added

- **[2025-11-21]** US-047: Registro Automático de Cambios en Hábitos
  ...
  - Relacionado: US-046, US-047

### Changed

- **[2025-11-21]** US-046: Modelo HabitAudit para Trazabilidad de Cambios
...
- **[2025-11-21]** US-045: Cacheo de Estadísticas con React Query
  Implementación completa de estrategia de cacheo inteligente para estadísticas usando TanStack Query (React Query). Se mejoró la configuración global del QueryClient con gcTime de 30 minutos, retry exponencial con backoff, y refetch automático on focus/reconnect. Se crearon custom hooks useGeneralStats y useHabitStats que encapsulan lógica de cache, refetch on focus con useFocusEffect, y utilities para invalidación. Se implementó invalidación automática de cache de estadísticas en todas las mutations de marcado de hábitos (CHECK, NUMERIC, retroactivo). Resultado: datos instantáneos desde cache, menos requests al servidor, mejor UX, y sincronización automática.
  - Componentes: apps/mobile/App.tsx, apps/mobile/src/hooks/useGeneralStats.ts, apps/mobile/src/hooks/useHabitStats.ts, apps/mobile/src/hooks/index.ts, apps/mobile/src/screens/HomeScreen.tsx, apps/mobile/src/screens/HabitStatsScreen.tsx, apps/mobile/src/screens/HabitosDiariosScreen.tsx
  - Relacionado: US-041, US-042, US-043

### Changed

- **[2025-11-21]** US-044: Evaluación e Instalación de Victory Native para Gráficos
  Tarea técnica completada: evaluación y selección de Victory Native v37 como librería de gráficos para React Native. Se documentó la decisión en ADR-004, se crearon 3 componentes wrapper reutilizables (CircularProgress, WeeklyChart, NumericValuesChart), y se generó documentación completa de uso. Victory Native v37 fue seleccionado sobre v41 por estabilidad de tipos TypeScript, sobre react-native-chart-kit por flexibilidad, y sobre react-native-svg-charts por mejor documentación y comunidad. Los componentes ya fueron implementados en US-041 y US-042.
  - Componentes: apps/mobile/package.json, apps/mobile/src/components/stats/CircularProgress.tsx, apps/mobile/src/components/stats/WeeklyChart.tsx, apps/mobile/src/components/stats/NumericValuesChart.tsx, apps/mobile/src/components/stats/CalendarHeatmap.tsx, doc/adr/ADR-004-seleccion-victory-native-para-graficos-mobile.md, apps/mobile/docs/CHARTS_COMPONENTS.md
  - Relacionado: US-041, US-042

### Added

- **[2025-11-21]** US-043: Feature de Marcado Retroactivo en Mobile
...
- **[2025-11-21]** US-038: Endpoint de Estadísticas de Hábito Específico
...
- **[2025-11-21]** US-037: Endpoint de Estadísticas Generales del Usuario
...
- **[2025-11-21]** US-036: Cron Job para Auto-completar Hábitos Numéricos
...
- **[2025-11-21]** US-035: Optimización de Queries para Cálculo de Rachas
  Implementación completa de optimizaciones de performance para el sistema de rachas. Se creó índice compuesto (habitId, date DESC) en HabitRecord, se limitó búsqueda histórica a 30 días, y se documentó el uso de caché denormalizado. Las optimizaciones reducen la complejidad de las queries de O(n) a O(1) para consultas de rachas, aprovechando los campos currentStreak, longestStreak y lastCompletedDate cacheados en el modelo Habit. El índice DESC permite búsquedas eficientes de registros recientes sin escanear toda la tabla.
  - Componentes: apps/backend/prisma/schema.prisma, apps/backend/src/services/streak.service.ts

### Added

- **[2025-11-21]** US-034: Animaciones y Celebraciones al Completar Hábitos
  ...
  - Relacionado: US-033, US-031

### Added

- **[2025-11-21]** US-033: Mejorar HabitosDiariosScreen con Marcado Interactivo
  ...
  - Relacionado: US-029, US-030, US-031, US-032, US-022

### Added

- **[2025-11-21]** US-032: Progreso Parcial para Hábitos Numéricos Acumulativos
  ...
  - Relacionado: US-029, US-030, US-031

### Added

- **[2025-11-21]** US-031: Algoritmo de Cálculo de Rachas (Streak Calculation Algorithm)
  ...
  - Relacionado: US-028, US-029, US-030

### Added

- **[2025-11-21]** Endpoint Retroactivo para Marcar H\u00e1bitos (US-030)
  ...
  - Relacionado: US-030, US-029

### Added

- **[2025-11-21]** Endpoint Registro de Completitudes de H\u00e1bitos (US-029)
  ...
  - Relacionado: US-029, US-028

### Changed

- **[2025-11-21]** Modelo HabitRecord para Historial de Completitudes (US-028)
...
- **[2025-11-20]** Eliminar H\u00e1bito con Toast de Deshacer (US-024)
...
- **[2025-11-20]** Formulario Mobile de Crear/Editar Hábitos (US-023)
...
- **[2025-11-20]** Pantalla de Lista de Hábitos Mobile (US-022)
  ...
  - Relacionado: US-021 (Backend CRUD - API consumida), US-025 (HabitDetail - navegación), US-023 (HabitForm - navegación crear/editar), US-024 (Delete Habit - funcionalidad incluida), US-018 (Categories - patrón base)

### Added

- **[2025-11-20]** Modelo de Hábitos y Endpoints CRUD Backend (US-021)
  ...
  - Relacionado: US-026 (Habit Types Shared - tipos base), US-027 (Validation Helpers - helpers complementarios), US-018 (Categories Backend - patrón base), US-022 (Lista Hábitos Mobile - consumirá GET /habits), US-023 (Form Hábito Mobile - consumirá POST/PUT /habits), US-024 (Delete Hábito - consumirá DELETE /habits/:id)

### Added

- **[2025-11-20]** Validation Helpers for Habits (US-027)
  ...
  - Relacionado: US-026 (Habit Types and Schemas - base types), US-023 (CRUD Hábitos Backend - usará helpers en HabitService), US-024 (Formulario Hábito Mobile - usará helpers en validación onChange), US-038 (Formulario Hábito Web - usará helpers en validación)

### Added

- **[2025-11-20]** Shared Package - Habit Types and Schemas (US-026)
  ...
  - Relacionado: US-015 (Category Types - patrón base), US-020 (Category Schemas - patrón base), US-023 (CRUD Hábitos Backend - consumirá estos tipos), US-024 (Formulario Hábito Mobile - consumirá estos tipos)

### Added

- **[2025-11-20]** Pantalla de Detalle de Hábito Mobile (US-025)
  ...
  - Relacionado: US-023 (CRUD Hábitos API), US-024 (Formulario Hábito Mobile), US-042 (Estadísticas Hábito - futuro)

### Added

- **[2025-11-20]** Implementación US-024: Eliminar Hábito con Swipe-to-Delete
  ...
  - Relacionado: US-022, US-023, US-053

### Added

- **[2025-11-20]** Implementación US-023: HabitFormScreen Mobile
  ...
  - Relacionado: US-022, US-025

### Added

- **[2025-11-20]** Implementación US-022: HabitsListScreen Mobile
  ...
  - Relacionado: US-015, US-023, US-025

### Added

- **[2025-11-20]** US-021: Modelo de Hábitos y API CRUD completa
  ...
  - Relacionado: US-014, US-019, US-022, US-023, US-026

### Changed

- **[2025-11-20]** US-020: Shared package con schemas Zod para categorías
  ...
  - Relacionado: US-014, US-015, US-001, US-002

### Added

- **[2025-11-20]** US-019: Seed automático de categorías default al registrarse
  ...
  - Relacionado: US-014, US-006, US-015

### Added

- **[2025-11-20]** US-018: Confirmación para cambio de categoría default
  ...
  - Relacionado: US-015, US-014

### Changed

- **[2025-11-20]** Configuración completa de React Native con Expo
...
- **[2025-11-20]** Estructura Preparatoria Mobile para Gestión de Categorías
  ...
  - Relacionado: US-015, US-014, US-016, US-020

### Added

- **[2025-11-20]** Sistema de Categorías con Enum Scope y Soft Delete
...
- **[2025-11-20]** Implementar CRUD completo de categor\u00edas
...
- **[2025-11-19]** Implementar tests del error middleware
...
- **[2025-11-19]** Crear README con documentaci\u00f3n de variables de entorno
...
- **[2025-11-19]** Implementar endpoint POST /api/auth/logout
...
- **[2025-11-19]** Implementar endpoint GET /api/auth/me
...
- **[2025-11-19]** Implementar endpoint de refresh token
...
- **[2025-11-19]** Auth Middleware para Token Verification (US-008)
...
- **[2025-11-19]** User Login Backend (US-007)
...
- **[2025-11-19]** User Registration Backend (US-006)
...
- **[2025-11-19]** Documentaci\u00f3n de Arquitectura Inicial (US-005)
